...
def concate_features(start_1, end_1, start_2, end_2, start_3, end_3, start_4, end_4, dframe):
    d_1 = dframe.iloc[:,start_1:end_1]
    #print(d_1)
    d_2 = dframe.iloc[:,start_2:end_2]
    #print(d_2)
    d_3 = dframe.iloc[:,start_3:end_3]
    #print(d_3)
    d_4 = dframe.iloc[:,start_4:end_4]
    #print(d_2)
    data = pd.concat([d_1, d_2, d_3, d_4], axis=1)
    #print(data)
    return data
...
file_name_3 = os.path.join(os.getcwd(),"..","..","..","","r","radiomics","","MAP_radiomics.csv")
file_name_4 = os.path.join(os.getcwd(),"..","..","..","","r","radiomics","","NAV_radiomics.csv")
...
HC_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","concat_4chan_r417","","HC_DvC.csv")
SCZ_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","concat_4chan_r417","","SCZ_DvC.csv")
DMSO_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","concat_4chan_r417","","DMSO_HvS.csv")
CHIR_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","concat_4chan_r417","","CHIR_HvS.csv")
...
HC_data=concate_features(start_1, end_1, start_2, end_2, start_3, end_3, start_4, end_4, HC_df)
SCZ_data=concate_features(start_1, end_1, start_2, end_2, start_3, end_3, start_4, end_4, SCZ_df)
DMSO_data=concate_features(start_1, end_1, start_2, end_2, start_3, end_3, start_4, end_4, DMSO_df)
CHIR_data=concate_features(start_1, end_1, start_2, end_2, start_3, end_3, start_4, end_4, CHIR_df)
print(HC_data)
print(SCZ_data)
print(DMSO_data)
print(CHIR_data)
