...
#outPath = os.path.join(os.getcwd(),"..","..","..","","r","radiomics","")
#outPath = inPath+"/radiomics"
#savePath = inPath+"/concat_perm_r417"

#savePath = os.path.join(os.getcwd(),"..","..","..","","r","radiomics","","non_concate_r417","")
#savePath = inPath + "/non_concate_r417"
...
file_name_1 = os.path.join(os.getcwd(),"..","..","..","","r","radiomics","","NAV_radiomics.csv")
...
HC_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","non_concat_r417","","NAV_HC.csv")
SCZ_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","non_concat_r417","","NAV_SCZ.csv")
DMSO_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","non_concat_r417","","NAV_DMSO.csv")
CHIR_save_name = os.path.join(os.getcwd(),"..","..","..","","r","","non_concat_r417","","NAV_CHIR.csv")
...
HC_data=HC_df.iloc[:,start_1:end_1]
SCZ_data=SCZ_df.iloc[:,start_1:end_1]
DMSO_data=DMSO_df.iloc[:,start_1:end_1]
CHIR_data=CHIR_df.iloc[:,start_1:end_1]
#print(HC_data)
#print(SCZ_data)
#print(DMSO_data)
#print(CHIR_data)
