...
def get_parser():
    ...
    parser.add_argument('--nbands', type=int, default=1, help="number of channels in the input image")
    #parser.add_argument('--channels', type=list, default = ["TUBB"], help="determines channels of input image")
    parser.add_argument('--channels', nargs='+', default = ["TUBB"], help="determines channels of input image")
    ...
    batch_size = 64 if device_count() == 0 else 64 * device_count()
